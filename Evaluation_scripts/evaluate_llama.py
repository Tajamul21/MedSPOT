...
def evaluate_step(image, instruction, gt_bbox, model, processor):
    ...
    prompt = (
        f"{instruction}\n\n"
        "Return ONLY a single coordinate pair.\n"
        ...
        "Do NOT output text.\n"
        "If unsure, guess.\n"
        "Your entire response must be only two numbers inside parentheses."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", default="meta-llama/Llama-3.2-11B-Vision-Instruct")
