...
def extract_point_from_text(text, W, H):
    # Strip <think>...</think> blocks — parse final answer only
    ...
    for p in patterns:
        ...
        if m:
            ...
            # Qwen2-VL outputs pixel coords — normalize by image size
            px, py = px / W, py / H
        ...
        "content": [
            {"type": "image", "image": image},
            {
                ...
                "text": (
                    ...
                    "Look carefully and identify the exact UI element described.\n"
                    "Return the pixel coordinates of the CENTER of that element.\n"
                    "Format strictly: (x,y)\n"
...
def evaluate_task(task, model, processor, dataset_root):
    ...
    for idx, step in enumerate(steps, start=1):
        ...
        # W, H returned from evaluate_step — no duplicate image open
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", default="Qwen/Qwen2-VL-7B-Instruct")
    ...
    RESULTS_ROOT = REPO_ROOT / "Results" / "Qwen2-VL"
